...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('programs', function (Blueprint $table) {
            ...
            $table->decimal('per_hectare_allocation', 5, 2)->default(1.00); // e.g., 2 bags per hectare
            $table->decimal('max_hectare_cap', 5, 2)->default(3.00); // e.g., max subsidy calculated up to 3 hectares
